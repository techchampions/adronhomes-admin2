...
// export default function Customers_singlepayment() {
//   const tabs = ["Payment List"];
...
//       <div className="bg-white rounded-[30px] w-full pt-[20px] lg:pt-[30px]  lg:pl-[43px]  lg:pr-[61px]  pl-[15px] pr-[15px] md:pb-[292px] pb-[80px]">
