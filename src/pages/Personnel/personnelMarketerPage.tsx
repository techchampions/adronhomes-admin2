...
// import { fetchMarketerDashboardpersonnel } from "../../components/Redux/Marketer/Dashboard_thunk";
import NotFound from "../../components/NotFound";
import LoadingAnimations from "../../components/LoadingAnimations";
import Header from "../../marketer/Header/Hearder";
import CustomersTableAllActive from "../../marketer/dashboard/activePlans";
import CompletedPlans from "../../marketer/dashboard/completedTable";
import Upcomingdata from "../../marketer/dashboard/Upcomingdata ";
import ReferralModal from "../../marketer/referalModal/referralModal";
import { fetchMarketerDashboardpersonnel } from "../../components/Redux/personnel/marketer_personnel_thunk";
import { useParams } from "react-router-dom";
// import Upcomingdata from "./Upcomingdata ";
// import CompletedPlans from "./completedTable";

export default function PersonnelMarketersDashboard() {
...
const {id}=useParams<{id:string}>();
  const { data, error, loading } = useSelector(
    (state: RootState) => state.marketerdashboardPersonnel,
  );
