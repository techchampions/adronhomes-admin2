...
import { ContractData } from "../../components/Redux/UpdateContract/viewcontractFormDetails";
  ...
  const handleDownloadContract = async () => {
    try {
      ...
      if (result.success && result.contract_download_link) {
        ...
        link.setAttribute('download', `contract-${contract.unique_contract_id}.pdf`);
      ...
      <div className="p-4 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <p><span className="font-medium">Contract ID:</span> {contract.unique_contract_id}</p>
            <p><span className="font-medium">Customer ID:</span> {contract.contract_customer_id}</p>
