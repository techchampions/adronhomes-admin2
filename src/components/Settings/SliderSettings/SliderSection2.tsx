...
const SliderItem: React.FC<{
  ...
  return (
    <div className="w-full md:w-[320px] rounded-lg">
      <div
          ...
          <div className="group relative col-span-2">
            ...
            <div className="absolute inset-0 bg-black/20 bg-opacity-0 group-hover:bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 rounded-lg">
              <button
                ...
                className="text-white text-sm bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded cursor-pointer"
...
export const SliderSection: React.FC<SliderSectionProps> = ({
  title,
  mobileResolution = "1080 x 566",
  desktopResolution = "1080 x 1400",
  description,
  initialSliders,
  sliderType,
}) => {
  ...
  return (
    <div className="mb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="w-full md:w-[320px] rounded-lg">
          <div className="border border-gray-300 rounded-lg p-2">
            <div className="grid grid-cols-3 space-x-2">
              <div className="group col-span-2 relative">
                <div className="text-xs text-gray-500 mb-1">Desktop Image</div>
                <div
                ...
                >
                  {newSliderFiles.desktop ? (
                    <img
                      src={URL.createObjectURL(newSliderFiles.desktop)}
                      alt=""
              ...
              <div className="group relative">
                <div className="text-xs text-gray-500 mb-1">Mobile Image</div>
                <div
                  className="w-full h-32 border-2  text-center border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center text-gray-400 cursor-pointer hover:bg-gray-50 transition-colors"
                  onClick={() => newMobileInputRef.current?.click()}
                >
                  {newSliderFiles.mobile ? (
                    <img
                      src={URL.createObjectURL(newSliderFiles.mobile)}
                      alt=""
                      className="w-full h-full"
                    />
                  ) : (
      ...
      <div className="mt-3 text-xs text-gray-500">
        <p>Desktop Resolution: {desktopResolution} pixels</p>
        <p>Mobile Resolution: {mobileResolution} pixels</p>
        <p>File Size: Max 5MB per image</p>
        <p>Formats Supported: JPG, JPEG, PNG</p>
        <p className="flex gap-1 items-center">
          <IoInformationCircle className="h-4 w-4" />
          Sliders are displayed in the order they appear above
        </p>
      </div>
    </div>
  );
