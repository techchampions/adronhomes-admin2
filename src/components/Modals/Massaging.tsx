    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-[40px] w-full max-w-md flex flex-col overflow-hidden relative">
        ...
        <div className="px-5 pb-3">
          <p className="text-[#767676] text-[16px] font-[350]">
            User will get message as a notification.
          </p>
        </div>
        ...
        <div className="px-5 pb-4 flex items-center gap-3">
          <div className="w-10 h-10 rounded-full overflow-hidden">
            <img
              src={userImage ? userImage : "/unknown.png"}
              alt="User avatar"
              className="w-full h-full object-cover"
            />
          </div>
          <span className="font-[350] text-dark text-lg max-w-xs truncate">
            {userNmae}
          </span>
        </div>
        ...
        <div className="mt-auto p-5 flex items-center justify-between bg-white rounded-[40px] absolute bottom-0 w-full">
          <button
            onClick={handleCancel}
            className="text-[#D70E0E] font-bold text-xs md:text-sm  hover:text-red-600"
          >
            Cancel
          </button>
