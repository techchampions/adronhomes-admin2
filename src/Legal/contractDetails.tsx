...
import { fetchUserPropertyPlan, clearUserPropertyPlan } from "../components/Redux/Marketer/user_property_plan";
import { createContractDocumentsThunk } from "../components/Redux/UpdateContract/createContractDocuments";
...
import { ReusableTable } from "../marketer/Table_one";
...
import { PaymentStatus } from "../pages/Customers/PaymentList";
...
export default function LegalContractInvoice() {
